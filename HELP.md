...
* The following dependency is not known to work with Spring Native: 'Spring Configuration Processor'. As a result, your
...
```
$ docker run --rm spring-study:0.0.1-SNAPSHOT
```
